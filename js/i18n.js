  ...
  const DICT = {
    vi: {
      ...
      home: {
        ...
        heroTitle: 'Chạm vào Di sản Hmông qua không gian 360, bản đồ và hành trình trải nghiệm',
        heroLead: 'Khám phá Hang Kia - Pà Cò và Mai Châu bằng tư liệu số, hình ảnh 360, hồ sơ điểm đến và các trải nghiệm gắn với cộng đồng địa phương.',
        heroPrimary: 'Khám phá 360',
        heroSecondary: 'Xem bản đồ',
        jumpMapTitle: 'Bản đồ',
        ...
        jumpBookText: 'Lọc lộ trình và đặt trải nghiệm phù hợp',
        ...
        bookingTitle: 'Khi đã xem đủ thông tin, khách có thể đi tiếp sang đặt trải nghiệm hoặc lọc lộ trình phù hợp',
        bookingLead: 'Trang đặt trải nghiệm giúp người xem chuyển nhanh từ bước khám phá sang bước lên kế hoạch thực tế: chọn địa điểm, xem gói phù hợp và lưu lại thông tin tra cứu đơn.',
        ...
        bookingCard2Title: 'Đi theo lộ trình phù hợp',
        bookingCard2Text: 'Chọn số người, thời gian, ngân sách và cách di chuyển để lọc gợi ý phù hợp.',
        ...
        routeKicker: 'Lộ trình gợi ý',
        routePeople: 'Số lượng người',
        routeDuration: 'Thời gian chuyến đi',
        routeBudget: 'Chi phí dự kiến (VNĐ/người)',
        routeTransport: 'Di chuyển',
        routeFilter: 'Lọc lộ trình',
        routeReset: 'Đặt lại',
        routePreparingMeta: 'Đang chuẩn bị gợi ý lộ trình...',
        routePreparingEmpty: 'Đang tải dữ liệu lộ trình...',
    ...
    en: {
      ...
      home: {
        ...
        heroTitle: 'Experience Hmong heritage through 360 views, digital maps, and curated journeys',
        heroLead: 'Discover Hang Kia - Pà Cò and Mai Châu through 360 scenes, destination profiles, and community-based experiences shaped with local partners.',
        heroPrimary: 'Explore 360',
        heroSecondary: 'View map',
        jumpMapTitle: 'Map',
        ...
        jumpBookText: 'Filter routes and book the right experience',
        ...
        bookingTitle: 'After exploring the content, visitors can continue to booking or filter a route that suits their trip',
        bookingLead: 'The booking page helps visitors move from browsing into action: choose a point, compare packages, and keep the tracking code for later updates.',
        ...
        bookingCard2Title: 'Follow a matching route',
        bookingCard2Text: 'Choose group size, time, budget, and transport to filter suitable suggestions.',
        ...
        routeReset: 'Reset',
        routePreparingMeta: 'Preparing route suggestions...',
        routePreparingEmpty: 'Loading route data...',
