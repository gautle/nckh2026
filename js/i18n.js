  ...
  const DICT = {
    vi: {
      ...
      library: {
        ...
        heroLead: 'Bắt đầu từ video quy trình, ảnh tư liệu, âm thanh, tài liệu nghiên cứu hoặc collection hoa văn để tra cứu kho tư liệu số theo đúng loại chất liệu bạn cần.',
        ...
        pathwaysLead: 'Mỗi nhóm là một tuyến tra cứu độc lập, đủ rõ để bạn chọn đường vào phù hợp chỉ sau vài giây đầu tiên.',
        highlightsKicker: 'Biểu ghi đáng chú ý',
        highlightsTitle: 'Một số biểu ghi mới số hóa hoặc cần xem trước',
        highlightsLead: 'Một nhịp duyệt nhanh để thấy ngay kho số đang chứa nhiều loại biểu ghi khác nhau.',
        collectionsKicker: 'Collection',
        collectionsTitle: 'Các collection hiện có trong kho tư liệu',
        collectionsLead: 'Mỗi collection là một nhóm tư liệu có thể tiếp tục mở rộng mà không đổi cấu trúc tra cứu.',
        recordsKicker: 'Biểu ghi tra cứu',
        recordsTitle: 'Biểu ghi số hóa có thể mở và đối chiếu ngay',
        recordsLead: 'Mỗi mục cho biết loại tư liệu, nguồn và trạng thái dữ liệu trước khi mở chi tiết.',
        resultsLoading: 'Đang nạp biểu ghi từ kho tư liệu số...',
        motifLoading: 'Đang chuẩn bị collection chuyên đề...',
        resultsLoadError: 'Kho tư liệu số chưa thể nạp dữ liệu ở thời điểm này.',
        ...
        videoLead: 'Duyệt nhanh các hồ sơ video về nhuộm chàm, thêu, dệt, may mặc thủ công và những công đoạn nghề liên quan.',
    ...
    en: {
      ...
      library: {
        ...
        heroLead: 'Start from process video, photo archive, oral narratives, research documents, or the motif collection to enter the repository through the material path you need.',
        ...
        pathwaysLead: 'Each group works as a distinct route into the repository, making first-time browsing faster and clearer.',
        highlightsKicker: 'Highlighted records',
        highlightsTitle: 'Selected and recently digitized records',
        highlightsLead: 'A quick scan row that shows the repository already contains multiple kinds of archive records.',
        collectionsKicker: 'Collections',
        collectionsTitle: 'Current collections in the repository',
        collectionsLead: 'Each collection is a material group that can keep growing without changing the archive structure.',
        recordsKicker: 'Archive records',
        recordsTitle: 'Digitized records available for direct browsing',
        recordsLead: 'Each card shows material type, source, and record status before you open the detail page.',
        resultsLoading: 'Loading records from the digital archive...',
        motifLoading: 'Preparing the specialist collection...',
        resultsLoadError: 'The digital archive cannot load its records right now.',
        ...
        videoLead: 'Browse process records for indigo dyeing, embroidery, weaving, hand sewing, and related craft actions.',
