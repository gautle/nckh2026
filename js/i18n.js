  ...
  const DICT = {
    vi: {
      ...
      library: {
        ...
        kicker: 'THƯ VIỆN SỐ',
        heroTitle: 'Kho tư liệu số về nghề may mặc và văn hóa Hmông',
        heroLead: 'Chọn một loại tư liệu để bắt đầu tra cứu nhanh trong kho số.',
        ...
        pathwaysLead: 'Mỗi nhóm là một đường vào rõ ràng để bắt đầu tra cứu nhanh.',
        ...
        motifCollapsedMeta: 'Landing page chỉ hiển thị một phần nhỏ của collection hoa văn.',
        motifExpandedMeta: 'Đang hiển thị toàn bộ collection ký hiệu và hoa văn.',
        motifToggleMore: 'Xem thêm hoa văn',
    ...
    en: {
      ...
      library: {
        ...
        heroTitle: 'Digital repository for Hmong dressmaking and cultural materials',
        heroLead: 'Choose a material type to begin browsing the archive quickly.',
        ...
        pathwaysLead: 'Each group works as a clear entry route for quick browsing.',
        ...
        motifCollapsedMeta: 'Only a small sample of motif records is shown on the landing page.',
        motifExpandedMeta: 'Showing the full motif and symbol collection.',
        motifToggleMore: 'Show more motifs',
